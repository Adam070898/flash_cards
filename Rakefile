...
desc "Displays all cards"
task "cards" do
  Card.all.each do |card|
    puts "Deck #{card.deck_id} - Q: \"#{card.question}\" A: \"#{card.answer}\""
  end
end

desc "Displays all decks"
task "decks" do
...
task "users" do
  User.all.each do |user|
    puts "User id: #{user.id} Name: #{user.name} email: #{user.email} Password: #{user.password}"
  end
end
